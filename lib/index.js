...
var BowerRequireJS = module.exports = function BowerRequireJS(options) {
  this.config = options.config || './';
  this.configDir = path.dirname(this.config);
  this.excludes = options.excludes || [];
  this.baseUrl = options.baseUrl || this.configDir;
  this.filePath = this.config;
  this.file = fs.readFileSync(String(this.filePath), 'utf-8');
  this.dependencies = [];
};

BowerRequireJS.prototype.run = function run(callback) {
  var self = this;
